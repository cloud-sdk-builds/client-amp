...
[`@aws-sdk/client-amp`](https://www.npmjs.com/package/@aws-sdk/client-amp/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I2bgiEIlMBnCjClTYe+d4Fn3exPDHDDQtIPoPHrejkqLCzZOf9GNM3X2LKfHlNxJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amp": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.170.0/index.min.mjs": "sha384-I2bgiEIlMBnCjClTYe+d4Fn3exPDHDDQtIPoPHrejkqLCzZOf9GNM3X2LKfHlNxJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amp/blob/refs/tags/3.170.0/LICENSE
```
