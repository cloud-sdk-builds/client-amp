...
[`@aws-sdk/client-amp`](https://www.npmjs.com/package/@aws-sdk/client-amp/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/8NXkasFrB9M3ngTIpv70Xorh3ezmzju7txUE6STI+8PBHhAczaEWiwR/kVLCuQF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amp": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.666.0/index.min.mjs": "sha384-/8NXkasFrB9M3ngTIpv70Xorh3ezmzju7txUE6STI+8PBHhAczaEWiwR/kVLCuQF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amp/blob/refs/tags/3.666.0/LICENSE
```
