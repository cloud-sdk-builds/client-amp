...
[`@aws-sdk/client-amp`](https://www.npmjs.com/package/@aws-sdk/client-amp/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pN0hajWqvA1+ZAyGezVSh3YpG1ZznPyX5XPCTvmDDrs7P16DJJLaImPJIO978aN1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amp": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amp@3.360.0/index.min.mjs": "sha384-pN0hajWqvA1+ZAyGezVSh3YpG1ZznPyX5XPCTvmDDrs7P16DJJLaImPJIO978aN1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amp/blob/refs/tags/3.360.0/LICENSE
```
